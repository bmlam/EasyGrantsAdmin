...
CREATE TABLE CRM_APP.PRODUCT AS SELECT * FROM DUAL;
CREATE TABLE CRM_APP."ORDER"   AS SELECT * FROM DUAL;
CREATE PACKAGE CRM_APP.PKG_ORDER_ENTRY AS BEGIN NULL; END;
/

-- sales_app schema objects for demo
CREATE TABLE SALES_APP.CUSTOMER AS SELECT * FROM DUAL;
CREATE TABLE SALES_APP.COMMS_CHANNEL   AS SELECT * FROM DUAL;
CREATE PACKAGE SALES_APP.COMMS_CHANNEL AS BEGIN NULL; END;
/
